...
test.describe('Homepage 100% Comprehensive Verification Suite @homepage-comp', () => {
  ...
  await test.step('Step 1: Start execution for full WCAG accessibility audit', async () => {
  ...
  await test.step('Step 2: Axe audit complete. Violations: ${results.violations.length}', async () => {
  ...
  await test.step('Step 3: TC-HPC-01 completed', async () => {
  ...
  await test.step('Step 1: Start execution for meta tags validation', async () => {
  ...
  await test.step('Step 3: Page title: "${title}"', async () => {
      logger.info(`Page title: "${title}"`);
      expect(title.length).toBeGreaterThan(10);
  
  });

  await test.step('Step 4: Check meta description exists and has content', async () => {
  ...
  await test.step('Step 5: Meta description: "${descContent?.substring(0, 80)}..."', async () => {
  ...
  await test.step('Step 6: Check canonical URL', async () => {
  ...
  await test.step('Step 7: Check Open Graph title', async () => {
  ...
  await test.step('Step 8: TC-HPC-02 completed', async () => {
  ...
  await test.step('Step 1: Start execution for console error monitoring', async () => {
  ...
  await test.step('Step 2: Console errors captured: ${consoleErrors.length}', async () => {
  ...
  await test.step('Step 3: TC-HPC-03 completed', async () => {
  ...
  await test.step('Step 1: Start execution for page title and URL validation', async () => {
      logger.info('Starting TC-HPC-04: Verify page title and URL');
  
  });

  await test.step('Step 2: Verify that the homepage title contains "Unitek College"', async () => {
      logger.info('Asserting that the homepage title contains "Unitek College"');
      await homePage.assertTitleContains('Unitek College');
  
  });

  await test.step('Step 3: Verify that the homepage URL contains "unitekcollege.edu"', async () => {
      logger.info('Asserting that the homepage URL contains "unitekcollege.edu"');
      await homePage.assertUrlContains('unitekcollege.edu');
  
  });

  await test.step('Step 4: Complete TC-HPC-04 successfully', async () => {
  ...
  await test.step('Step 1: Start execution for top bar elements visibility and alignment', async () => {
      logger.info('Starting TC-HPC-05: Top bar elements visibility and alignment');
  
  });

  await test.step('Step 2: Verify brand logo is visible', async () => {
  ...
  await test.step('Step 3: Verify search toggle icon is visible', async () => {
  ...
  await test.step('Step 4: Verify Get Info CTA is visible', async () => {
  ...
  await test.step('Step 5: Validating phone link href contains tel: protocol', async () => {
      logger.info('Validating phone link href contains tel: protocol');
  });
    const phoneHref = await homePage.getPhoneLinkHref();

  await test.step('Step 6: Phone href: ${phoneHref}', async () => {
  ...
  await test.step('Step 7: Verify horizontal alignment of logo and search icon', async () => {
  ...
  await test.step('Step 8: TC-HPC-05 completed', async () => {
  ...
  await test.step('Step 1: Start execution for top bar layout alignment and elements visibility validation', async () => {
      logger.info('Starting TC-HPC-06: Verify top bar layout alignment and elements visibility');
  
  });

  await test.step('Step 2: Locate the "Get Info", "Search Toggle", and "Logo" elements', async () => {
  ...
  await test.step('Step 3: Verify that the "Get Info" link is visible', async () => {
      logger.info('Asserting that the "Get Info" link is visible');
      await expect(getInfoLocator).toBeVisible();
      
  });

  await test.step('Step 4: Verify that the "Search Toggle" button is visible', async () => {
      logger.info('Asserting that the "Search Toggle" button is visible');
      await expect(searchLocator).toBeVisible();
      
  });

  await test.step('Step 5: Verify that the main "Brand Logo" is visible', async () => {
  ...
  await test.step('Step 6: Verify horizontal layout alignment of Main Brand Logo and Header Search Icon with a 60px tolerance', async () => {
  ...
  await test.step('Step 7: Complete TC-HPC-06 successfully', async () => {
  ...
  await test.step('Step 1: Start execution for navigation items visibility and alignment', async () => {
      logger.info('Starting TC-HPC-07: Navigation items visibility and alignment');
  
  });

  await test.step('Step 2: Verify ${NAV_ITEMS.length} navigation items are visible', async () => {
      logger.info(`Verifying ${NAV_ITEMS.length} navigation items are visible`);
      await homePage.verifyAllNavItemsVisible(NAV_ITEMS);
  
  });

  await test.step('Step 3: Check horizontal alignment of first 3 nav items', async () => {
  ...
  await test.step('Step 4: TC-HPC-07 completed', async () => {
  ...
  await test.step('Step 1: Start execution for all main navigation items are visible and horizontally aligned validation', async () => {
      logger.info('Starting TC-HPC-08: Verify all main navigation items are visible and horizontally aligned');
  
  });

  await test.step('Step 2: Verify main navigation items visibility in Page Object Model (POM)', async () => {
      logger.info('Verifying main navigation items visibility in Page Object Model (POM)');
      await homePage.verifyAllNavItemsVisible(NAV_ITEMS);
  });

  await test.step('Step 3: All listed main navigation items are confirmed visible', async () => {
      logger.info('All listed main navigation items are confirmed visible');
  
  });

  await test.step('Step 4: Retrieve locators for the first 3 navigation items to check horizontal layout alignment', async () => {
  ...
  await test.step('Step 5: Verify horizontal alignment of the top 3 navigation links with a 25px tolerance limit', async () => {
      logger.info('Asserting horizontal alignment of the top 3 navigation links with a 25px tolerance limit');
      await LayoutHelper.assertHorizontalAlignment(navLocators, 25, 5);
  
  });

  await test.step('Step 6: Complete TC-HPC-08 successfully', async () => {
  ...
  await test.step('Step 1: Start execution for language toggle EN → ES → back with content translation verification', async () => {
  ...
  await test.step('Step 2: Verify initial language state is English (EN)', async () => {
  ...
  await test.step('Step 3: English (EN) label is active', async () => {
  ...
  await test.step('Step 4: Main navigation contains exact English text ("Programs, menu item")', async () => {
      logger.info('Main navigation contains exact English text ("Programs, menu item")');
  
      // ── Toggle to Spanish (ES) ──
  });

  await test.step('Step 5: Click language toggle hitarea to switch to Spanish', async () => {
  ...
  await test.step('Step 6: Waiting for active language label to update to "ES"', async () => {
  ...
  await test.step('Step 7: Spanish (ES) label is now active', async () => {
      logger.info('Spanish (ES) label is now active');
  
      // Verify page content gets translated to Spanish (Wait for GTranslate to apply)
  });

  await test.step('Step 8: Waiting for page navigation to translate to Spanish', async () => {
  ...
  await test.step('Step 9: Main navigation successfully translated to Spanish ("Programas, elemento del menú") ✓', async () => {
  ...
  await test.step('Step 10: HTML tag lang attribute: "${langAttr}"', async () => {
  ...
  await test.step('Step 11: Click language toggle hitarea to switch back to English', async () => {
  ...
  await test.step('Step 12: Waiting for active language label to update back to "EN"', async () => {
  ...
  await test.step('Step 13: English (EN) label is active again', async () => {
      logger.info('English (EN) label is active again');
  
      // Verify navigation changes back to English
  });

  await test.step('Step 14: Waiting for page navigation to translate back to English', async () => {
  ...
  await test.step('Step 15: Main navigation contains English text again ("Programs, menu item") ✓', async () => {
      logger.info('Main navigation contains English text again ("Programs, menu item") ✓');
  
  });

  await test.step('Step 16: TC-HPC-10 round-trip and content translation validated successfully ✓', async () => {
  ...
  await test.step('Step 1: Start execution for language toggle functionality validation', async () => {
      logger.info('Starting TC-HPC-11: Verify language toggle functionality');
  
  });

  await test.step('Step 2: Check if the active language is English', async () => {
      logger.info('Checking if the active language is English');
  });
    const isEnglish = await homePage.isEnglishActive();

  await test.step('Step 3: Is English active? ${isEnglish}', async () => {
      logger.info(`Is English active? ${isEnglish}`);
      
  });

  await test.step('Step 4: Verify that English language is active initially', async () => {
      logger.info('Asserting that English language is active initially');
      expect(isEnglish).toBeTruthy();
  
  });

  await test.step('Step 5: Toggling the language', async () => {
  ...
  await test.step('Step 6: Verify that the URL still points to the correct domain after language toggle', async () => {
      logger.info('Verifying that the URL still points to the correct domain after language toggle');
      await homePage.assertUrlContains('unitekcollege.edu');
  
  });

  await test.step('Step 7: Complete TC-HPC-11 successfully', async () => {
  ...
  await test.step('Step 1: Start execution for mega menu open/close lifecycle', async () => {
      logger.info('Starting TC-HPC-12: Mega menu open/close lifecycle');
  
  });

  await test.step('Step 2: Opening Programs mega menu', async () => {
      logger.info('Opening Programs mega menu');
      await homePage.openProgramsMegaMenu();
  
  });

  await test.step('Step 3: Verify mega menu is visible', async () => {
      logger.info('Verifying mega menu is visible');
  });
    const isVisible = await homePage.isMegaMenuVisible();

  await test.step('Step 4: Mega menu visible: ${isVisible}', async () => {
      logger.info(`Mega menu visible: ${isVisible}`);
      expect(isVisible).toBeTruthy();
  
  });

  await test.step('Step 5: Closing mega menu', async () => {
      logger.info('Closing mega menu');
      await homePage.closeMegaMenu();
  
  });

  await test.step('Step 6: TC-HPC-12 completed', async () => {
  ...
  await test.step('Step 1: Start execution for programs mega menu opens and shows sections validation', async () => {
      logger.info('Starting TC-HPC-13: Verify Programs mega menu opens and shows sections');
  
  });

  await test.step('Step 2: Triggering the Programs mega menu to open', async () => {
      logger.info('Triggering the Programs mega menu to open');
      await homePage.openProgramsMegaMenu();
  
  });

  await test.step('Step 3: Verify if the Programs mega menu is visible', async () => {
      logger.info('Verifying if the Programs mega menu is visible');
  });
    const isMegaMenuVisible = await homePage.isMegaMenuVisible();

  await test.step('Step 4: Programs mega menu visibility: ${isMegaMenuVisible}', async () => {
      logger.info(`Programs mega menu visibility: ${isMegaMenuVisible}`);
      
  });

  await test.step('Step 5: Verify that the mega menu visibility is truthy', async () => {
      logger.info('Asserting that the mega menu visibility is truthy');
      expect(isMegaMenuVisible).toBeTruthy();
  
  });

  await test.step('Step 6: Closing the Programs mega menu', async () => {
      logger.info('Closing the Programs mega menu');
      await homePage.closeMegaMenu();
  
  });

  await test.step('Step 7: Complete TC-HPC-13 successfully', async () => {
  ...
  await test.step('Step 1: Start execution for search overlay lifecycle and focus trap', async () => {
      logger.info('Starting TC-HPC-14: Search overlay lifecycle and focus trap');
  
  });

  await test.step('Step 2: Opening search overlay', async () => {
      logger.info('Opening search overlay');
      await searchPage.openSearch();
  
  });

  await test.step('Step 3: Verify search input is visible', async () => {
  ...
  await test.step('Step 4: Pressing Escape key to close search overlay', async () => {
  ...
  await test.step('Step 5: TC-HPC-14 completed', async () => {
  ...
  await test.step('Step 1: Start execution for search overlay opens and closes validation', async () => {
      logger.info('Starting TC-HPC-15: Verify search overlay opens and closes');
  
  });

  await test.step('Step 2: Opening the search overlay', async () => {
      logger.info('Opening the search overlay');
      await searchPage.openSearch();
  
  });

  await test.step('Step 3: Verify if the search input field is visible', async () => {
      logger.info('Verifying if the search input field is visible');
  });
    const inputVisible = await searchPage.isSearchInputVisible();

  await test.step('Step 4: Search input visible: ${inputVisible}', async () => {
      logger.info(`Search input visible: ${inputVisible}`);
      
  });

  await test.step('Step 5: Verify that the search input is visible (truthy)', async () => {
      logger.info('Asserting that the search input is visible (truthy)');
      expect(inputVisible).toBeTruthy();
  
  });

  await test.step('Step 6: Closing the search overlay', async () => {
      logger.info('Closing the search overlay');
      await searchPage.closeSearch();
  
  });

  await test.step('Step 7: Complete TC-HPC-15 successfully', async () => {
  ...
  await test.step('Step 5: Check H1 typography (font-size)', async () => {
      logger.info('Checking H1 typography (font-size)');
  });
    const fontSize = await heroH1.evaluate((el) => getComputedStyle(el).fontSize);

  await test.step('Step 6: Hero H1 font-size: ${fontSize}', async () => {
  ...
  await test.step('Step 7: Check H1 font-weight is bold', async () => {
      logger.info('Checking H1 font-weight is bold');
  });
    const fontWeight = await heroH1.evaluate((el) => getComputedStyle(el).fontWeight);

  await test.step('Step 8: Hero H1 font-weight: ${fontWeight}', async () => {
  ...
  await test.step('Step 9: TC-HPC-16 completed', async () => {
  ...
  await test.step('Step 1: Start execution for hero subheading layout', async () => {
  ...
  await test.step('Step 2: Subheading visible: ${isSubheadingVisible}', async () => {
  ...
  await test.step('Step 3: TC-HPC-17 completed', async () => {
  ...
  await test.step('Step 1: Start execution for hero section layout structure, spacing, and visibility validation', async () => {
      logger.info('Starting TC-HPC-18: Verify hero section layout structure, spacing, and visibility');
  
  });

  await test.step('Step 2: Locate hero heading and subheading elements', async () => {
  ...
  await test.step('Step 3: Verify that the hero heading locator is visible on the page', async () => {
      logger.info('Asserting that the hero heading locator is visible on the page');
      await expect(headingLocator).toBeVisible();
      
  });

  await test.step('Step 4: Check if the hero tagline subheading locator is visible', async () => {
  ...
  await test.step('Step 5: Hero subheading visibility status: ${isSubheadingVisible}', async () => {
  ...
  await test.step('Step 6: Complete TC-HPC-18 successfully', async () => {
  ...
  await test.step('Step 1: Start execution for statistics section validation', async () => {
      logger.info('Starting TC-HPC-19: Statistics section validation');
  
  });
    const statsVisible = await homePage.isStatsSectionVisible();

  await test.step('Step 2: Stats section visible: ${statsVisible}', async () => {
  ...
  await test.step('Step 3: TC-HPC-19 completed', async () => {
  ...
  await test.step('Step 1: Start execution for statistics section displays correct layout validation', async () => {
      logger.info('Starting TC-HPC-20: Verify statistics section displays correct layout');
  
  });

  await test.step('Step 2: Check if the statistics section is present on the page', async () => {
      logger.info('Checking if the statistics section is present on the page');
  });
    const statsVisible = await homePage.isStatsSectionVisible();

  await test.step('Step 3: Statistics section visible: ${statsVisible}', async () => {
  ...
  await test.step('Step 4: Complete TC-HPC-20 successfully', async () => {
  ...
  await test.step('Step 1: Start execution for programs section verification', async () => {
      logger.info('Starting TC-HPC-22: Programs section verification');
  
  });

  await test.step('Step 2: Verify Programs section heading', async () => {
  ...
  await test.step('Step 3: Program tabs found: ${tabsCount}', async () => {
  ...
  await test.step('Step 4: TC-HPC-22 completed', async () => {
  ...
  await test.step('Step 1: Start execution for costs section verification', async () => {
  ...
  await test.step('Step 2: Costs heading visible: ${isVisible}', async () => {
  ...
  await test.step('Step 3: TC-HPC-24 completed', async () => {
  ...
  await test.step('Step 1: Start execution for accreditation badges are displayed validation', async () => {
      logger.info('Starting TC-HPC-26: Verify accreditation badges are displayed');
  
  });

  await test.step('Step 2: Verify accreditations logos and badges visibility under the homepage logo carousel/section', async () => {
  ...
  await test.step('Step 3: Accreditation badges are confirmed visible', async () => {
      logger.info('Accreditation badges are confirmed visible');
  
  });

  await test.step('Step 4: Complete TC-HPC-26 successfully', async () => {
  ...
  await test.step('Step 1: Start execution for fAQ accordion full interaction', async () => {
      logger.info('Starting TC-HPC-27: FAQ accordion full interaction');
  
  });
    const tabsCount = await homePage.getFaqTabCount();

  await test.step('Step 2: FAQ category tabs found: ${tabsCount}', async () => {
  ...
  await test.step('Step 3: TC-HPC-27 completed', async () => {
  ...
  await test.step('Step 1: Start execution for fAQ accordion expand/collapse and vertical spacing validation', async () => {
      logger.info('Starting TC-HPC-28: Verify FAQ accordion expand/collapse and vertical spacing');
  
  });

  await test.step('Step 2: Retrieve the total number of FAQ tabs', async () => {
      logger.info('Retrieving the total number of FAQ tabs');
  });
    const faqTabCount = await homePage.getFaqTabCount();

  await test.step('Step 3: Total FAQ tabs found: ${faqTabCount}', async () => {
  ...
  await test.step('Step 4: Complete TC-HPC-28 successfully', async () => {
  ...
  await test.step('Step 1: Start execution for hero lead form verification', async () => {
  ...
  await test.step('Step 2: Form container: ${box.width}px × ${box.height}px', async () => {
  ...
  await test.step('Step 3: TC-HPC-29 completed', async () => {
  ...
  await test.step('Step 1: Start execution for bottom lead form fields', async () => {
  ...
  await test.step('Step 2: TC-HPC-31 completed', async () => {
  ...
  await test.step('Step 1: Start execution for empty form submission validation', async () => {
  ...
  await test.step('Step 2: TC-HPC-32 completed', async () => {
  ...
  await test.step('Step 1: Start execution for footer visibility and links count', async () => {
  ...
  await test.step('Step 2: Total footer links: ${linkCount}', async () => {
  ...
  await test.step('Step 3: Log footer dimensions', async () => {
  ...
  await test.step('Step 4: TC-HPC-35 completed', async () => {
  ...
  await test.step('Step 1: Start execution for footer layout space and links presence validation', async () => {
      logger.info('Starting TC-HPC-36: Verify footer layout space and links presence');
  
  });

  await test.step('Step 2: Scroll to the bottom of the page to load the footer', async () => {
      logger.info('Scrolling to the bottom of the page to load the footer');
      await homePage.scrollToBottom();
  
  });

  await test.step('Step 3: Locate the footer element', async () => {
      logger.info('Locating the footer element');
  });
    const footer = page.locator('footer');
    

  await test.step('Step 4: Verify that the footer element is visible', async () => {
  ...
  await test.step('Step 5: Locate links inside the footer', async () => {
      logger.info('Locating links inside the footer');
  });
    const footerLinks = page.locator('footer a');
    const linkCount = await footerLinks.count();

  await test.step('Step 6: Total links found in the footer: ${linkCount}', async () => {
      logger.info(`Total links found in the footer: ${linkCount}`);
      
  });

  await test.step('Step 7: Verify that the footer has more than 5 links', async () => {
  ...
  await test.step('Step 8: Retrieve bounding box dimensions for the footer container', async () => {
  ...
  await test.step('Step 9: Log footer container dimensions', async () => {
      logger.info(`Footer container dimensions: width=${box.width}px, height=${box.height}px`);
      
  });

  await test.step('Step 10: Verify that footer width is greater than 500px', async () => {
      logger.info('Asserting that footer width is greater than 500px');
      expect(box.width).toBeGreaterThan(500);
      
  });

  await test.step('Step 11: Verify that footer height is greater than 100px', async () => {
      logger.info('Asserting that footer height is greater than 100px');
      expect(box.height).toBeGreaterThan(100);
  
  });

  await test.step('Step 12: Complete TC-HPC-36 successfully', async () => {
  ...
  await test.step('Step 1: Start execution for social media links validation', async () => {
  ...
  await test.step('Step 2: Found ${foundCount} social media links out of ${socialPlatforms.length}', async () => {
      logger.info(`Found ${foundCount} social media links out of ${socialPlatforms.length}`);
  
  });

  await test.step('Step 3: TC-HPC-37 completed', async () => {
  ...
  await test.step('Step 1: Start execution for footer broken link check', async () => {
  ...
  await test.step('Step 2: Check ${count} footer links for valid hrefs', async () => {
  ...
  await test.step('Step 3: Broken/suspicious links: ${brokenCount} out of ${maxToCheck} checked', async () => {
      logger.info(`Broken/suspicious links: ${brokenCount} out of ${maxToCheck} checked`);
      expect(brokenCount).toBeLessThanOrEqual(2);
  
  });

  await test.step('Step 4: TC-HPC-38 completed', async () => {
  ...
  await test.step('Step 1: Start execution for image alt-text validation', async () => {
  ...
  await test.step('Step 2: Total images on page: ${imgCount}', async () => {
  ...
  await test.step('Step 3: Images missing alt: ${missingAltCount} out of ${maxToCheck}', async () => {
  ...
  await test.step('Step 4: TC-HPC-39 completed', async () => {
  ...
  await test.step('Step 1: Start execution for keyboard Tab navigation', async () => {
  ...
  await test.step('Step 2: Tab order (first 10): ${focusedElements.join(\' → \')}', async () => {
  ...
  await test.step('Step 3: Interactive elements that received focus: ${interactiveCount}/10', async () => {
      logger.info(`Interactive elements that received focus: ${interactiveCount}/10`);
      expect(interactiveCount).toBeGreaterThanOrEqual(3);
  
  });

  await test.step('Step 4: TC-HPC-40 completed', async () => {
  ...
  await test.step('Step 1: Start execution for desktop viewport navigation check', async () => {
      logger.info('Starting TC-HPC-41: Desktop viewport navigation check');
  
  });
    const viewport = page.viewportSize();

  await test.step('Step 2: Current viewport: ${viewport?.width}×${viewport?.height}', async () => {
  ...
  await test.step('Step 3: TC-HPC-41 completed', async () => {
  ...
  await test.step('Step 1: Start execution for horizontal overflow check', async () => {
  ...
  await test.step('Step 2: Body scroll width: ${overflowInfo.bodyScrollWidth}px, Client width: ${overflowInfo.htmlClientWidth}px', async () => {
      logger.info(`Body scroll width: ${overflowInfo.bodyScrollWidth}px, Client width: ${overflowInfo.htmlClientWidth}px`);
  });

  await test.step('Step 3: Has horizontal overflow: ${overflowInfo.hasOverflow}', async () => {
  ...
  await test.step('Step 4: TC-HPC-42 completed', async () => {
